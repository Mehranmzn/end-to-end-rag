...
class RAG:
    def __init__(self, web_url):
        ...
        self.groq_llm = ChatGroq(api_key=os.getenv("GROQ_API_KEY"), model="llama3-70b-8192", temperature=0)
        ...
        self.rag_prompt = hub.pull("rlm/rag-prompt", api_key=os.getenv("LANGSMITH_API_KEY"))
